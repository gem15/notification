...
public class MonitorLogDao {
     ...
     *
     */
    // private static final String SELECT_MONITOR_LOG = "SELECT ORDER_UID,STATUS,MSG_TYPE,START_DATE,END_DATE,FILE_NAME,MSG,VN,INFO FROM MONITOR_LOG WHERE ID = :id";

    // private static final String INSERT_QUERY = "Insert into MONITOR_LOG (ORDER_UID,STATUS,MSG_TYPE,FILE_NAME,MSG,VN,INFO) values (?,?,?,?,?,?,?)";//START_DATE,END_DATE,
