...
public class ObjectFactory {
    ...
    private final static QName _ShipmentNotifLine_QNAME = new QName("http://www.severtrans.com", "line");
    ...
    /**
     * Create an instance of {@link NotificationLineTest }
     * 
     */
    public NotificationLineTest createNotificationLineTest() {
        return new NotificationLineTest();
    }
    ...
    /**
     * Create an instance of {@link NotificationTest }
     * 
     */
    public NotificationTest createNotificationTest() {
    ...
    /**
     * Create an instance of {@link NotificationLine }
     * 
     */
    public NotificationLine createNotificationLine() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NotificationLine }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.severtrans.com", name = "line", scope = ShipmentNotif.class)
    public JAXBElement<NotificationLine> createShipmentNotifLine(NotificationLine value) {
        return new JAXBElement<NotificationLine>(_ShipmentNotifLine_QNAME, NotificationLine.class, ShipmentNotif.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.severtrans.com", name = "line", scope = PickNotifLine.class)
    public JAXBElement<NotificationLine> createPickNotifLineLine(NotificationLine value) {
        return new JAXBElement<NotificationLine>(_ShipmentNotifLine_QNAME, NotificationLine.class, PickNotifLine.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.severtrans.com", name = "line", scope = DeliveryNotif.class)
    public JAXBElement<NotificationLine> createDeliveryNotifLine(NotificationLine value) {
        return new JAXBElement<NotificationLine>(_ShipmentNotifLine_QNAME, NotificationLine.class, DeliveryNotif.class, value);
    }
